  ...
  Morris.Line = (function(superClass) {
    ...
    Line.prototype.calcPoints = function() {
      ...
      for (k = 0, len = ref.length; k < len; k++) {
        ...
        results.push(row._ymax = Math.min.apply(null, [this.bottom].concat((function() {
          var len1, m, ref1, results1;
          ref1 = row._y;
          results1 = [];
          for (m = 0, len1 = ref1.length; m < len1; m++) {
    ...
    Line.prototype.generatePaths = function() {
      ...
      return this.paths = (function() {
        ...
        for (i = k = 0, ref = this.options.ykeys.length; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
          smooth = this.options.smooth === true || (ref1 = this.options.ykeys[i], indexOf.call(this.options.smooth, ref1) >= 0);
          coords = (function() {
          ...
          if (this.options.continuousLine) {
            coords = (function() {
              var len, m, results1;
              results1 = [];
              for (m = 0, len = coords.length; m < len; m++) {
                c = coords[m];
                if (c.y !== null) {
                  results1.push(c);
                }
